...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h5 class="fw-bold mb-0" style="color: #2c3e50; letter-spacing: -0.5px;">Edit Penulis</h5>
            ...
            <form action="{{ route('penulis.update', $penulis->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-3 mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('nama_depan') is-invalid @enderror" id="nama_depan"
                            ...
                            placeholder="Masukkan nama depan" style="border-radius: 8px; font-size: 13.5px; padding: 10px 14px;">
                        @error('nama_depan')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('user_name') is-invalid @enderror" id="user_name"
                        ...
                        placeholder="Masukkan username" style="border-radius: 8px; font-size: 13.5px; padding: 10px 14px;">
                    @error('user_name')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="mb-3">
                    ...
                    <input type="password" class="form-control @error('password') is-invalid @enderror" id="password"
                        name="password" placeholder="Kosongkan jika tidak ingin mengubah password" style="border-radius: 8px; font-size: 13.5px; padding: 10px 14px;">
                ...
                <div class="mb-4">
                    ...
                    <div class="mb-2">
                        <img src="{{ asset('storage/foto/' . $penulis->foto) }}" alt="Foto Profil"
                            style="width: 60px; height: 60px; object-fit: cover; border-radius: 50%; border: 2px solid #ffffff; box-shadow: 0 4px 8px rgba(0,0,0,0.05);">
                    </div>
                    <input type="file" class="form-control @error('foto') is-invalid @enderror" id="foto"
                        name="foto" accept="image/jpg,image/jpeg,image/png" style="border-radius: 8px; font-size: 13.5px; padding: 8px 12px;">
                    <div class="form-text" style="font-size: 12px; color: #718096;">
                        Format yang diizinkan: JPG, JPEG, PNG. Ukuran maksimal 2 MB. Kosongkan jika tidak ingin mengubah foto.
                    </div>
                    @error('foto')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
